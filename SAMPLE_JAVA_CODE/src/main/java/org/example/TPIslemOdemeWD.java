 ...
 *         &lt;element name="Doviz_Kodu" type="{http://www.w3.org/2001/XMLSchema}int"/&gt;
...
@XmlRootElement(name = "TP_Islem_Odeme_WD")
public class TPIslemOdemeWD {

    @XmlElement(name = "G", required = true)
    protected STWSGuvenlik g;
    @XmlElement(name = "Doviz_Kodu")
    protected int dovizKodu;
     ...
     * 
     */
    public void setDovizKodu(int value) {
