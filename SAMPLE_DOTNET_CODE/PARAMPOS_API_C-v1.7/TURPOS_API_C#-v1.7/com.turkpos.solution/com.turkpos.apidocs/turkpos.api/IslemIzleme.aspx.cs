...
{
    public partial class IslemIzleme : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            var response =
                service.TP_Islem_Izleme(gNesnesi, txbGUID.Text, txbBasTarih.Text, txbBitTarih.Text, txbIslemTip.Text,txbIslemDurum.Text);
