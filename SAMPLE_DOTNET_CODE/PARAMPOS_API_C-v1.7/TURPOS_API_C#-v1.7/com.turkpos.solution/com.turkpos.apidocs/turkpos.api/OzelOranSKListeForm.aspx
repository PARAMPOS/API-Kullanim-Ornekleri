<%@ Page Title="" Language="C#" MasterPageFile="~/turkpos.api/ApiForms.Master" AutoEventWireup="true" CodeBehind="OzelOranSKListeForm.aspx.cs" Inherits="com.turkpos.apidocs.turkpos.api.OzelOranSKListeForm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section role="form" class="section-form">
        <legend class="center-align">
            <h3>TP_Ozel_Oran_SK_Liste Metodu</h3>
        </legend>
        <hr />
        <br />
        ...
        <br />
        <div class="center-align">
            <asp:Button Text="Özel Oran SK Listele" runat="server" ID="btnSubmit" OnClick="btnSubmit_Click" Width="70%" />
        </div>
    </section>
    <div class="clearfx"></div>
    <br />
    ...
    <br />
    <section>
        <asp:GridView runat="server" ID="grdSonuc" AutoGenerateColumns="false" DataKeyNames="Ozel_Oran_SK_ID">
            <Columns>
